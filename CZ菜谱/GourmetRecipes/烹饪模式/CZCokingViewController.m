...
- (void)addRightView{
    ...
    [self.rightView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.height.equalTo(weakSelf.view.mas_height);
        make.width.equalTo(weakSelf.view.mas_width).with.offset(-51);
        make.top.equalTo(weakSelf.view.mas_top);
        make.left.equalTo(weakSelf.view).with.offset(51);
    }];
...
- (void)addTimer1{
    ...
    self.timer1 = [NSTimer timerWithTimeInterval:self.allSecond repeats:NO block:^(NSTimer * _Nonnull timer) {
