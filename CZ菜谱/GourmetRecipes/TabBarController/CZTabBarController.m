...
//    UINavigationController *navi = [[UINavigationController alloc]initWithRootViewController:[[CZMainViewController alloc]init]];
    ...
    CGFloat seachX = self.view.frame.size.width-15;
    CGFloat seachY = 64;
    CGFloat seachW = 30;
    CGFloat seachH = 30;
...
- (void)textFieldDidBeginEditing:(UITextField *)textField{
    [UIView animateWithDuration:0.3 animations:^{
        self.searchField.frame = CGRectMake(1.0 *self.view.frame.size.width/3-20, 64, self.view.frame.size.width*2/3, 30);
    }];
