...
- (void)addStepDirectory{
    for (int i=0; i<self.steps.count; i++) {
        ...
        [button mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.equalTo(weakSelf.mas_top).with.offset(100+i*25);
        }];
        if (i+1 == self.inter) {
...
- (void)addTiming{
    ...
    [timingBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(timingView.mas_left);
        make.top.equalTo(timingView.mas_top);
    }];
    ...
    [timingLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(timingView.mas_left);
        make.bottom.equalTo(timingView.mas_bottom);
    }];
